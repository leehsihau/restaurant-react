...
export const postFeedback = (fname, lname, telnum, email, agree, contactType, feedbackMsg) => (dispatch) => {
...
export const fetchLeaders = () => (dispatch) => {
    ...
    return fetch(baseUrl + 'leaders').then(response => {
        ...
        //don't hear anything from the server
        var errmess = new Error(error.message);
        throw errmess;
    }).then(response => response.json())
        .then(leaders => dispatch(addLeaders(leaders))).catch(error => {
